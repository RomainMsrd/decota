...
multi = [['Real_World_OH', 'Clipart_OH'],['Real_World_OH', 'Product_OH'],['Real_World_OH', 'Art_OH'],['Product_OH', 'Real_World_OH'],['Product_OH', 'Clipart_OH'],['Product_OH', 'Art_OH'],['Art_HO', 'Product_OH'],['Art_HO', 'Clipart_OH'],['Art_HO', 'Real_World_OH'],['Clipart_HO', 'Real_World_OH'],['Clipart_HO', 'Art_OH'],['Clipart_HO', 'Product_OH']]
...
def train():
    ...
    for step in range(args.start, all_step):
        ...
        u_2_prob = torch.softmax(net(im_data_tu), dim=1)
        ...
        if step % args.save_interval == 0:
            ...
            acc_test = test_ensemble(target_loader_test)
            acc_val = test_ensemble(target_loader_val)
            ...
            with open(record_file, 'a') as f:
                f.write('step %d mico %f best mico %f best val %f \n' % (step,     
                                                                         acc_test,
                                                                         best_acc_test,
                                                                         best_acc))
            net.train()
...
if args.eval:
    print('eval mode...')
    acc_test = test_ensemble(target_loader_test)
    print('mico acc: {}'.format(acc_test))
else:
    train()
